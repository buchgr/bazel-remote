...
func TestCacheExistingFiles(t *testing.T) {
	...
	items := []struct {
		...
		},
		{
			...
			"ac/73/733e21b37cef883579a88183eed0d00cdeea0b59e1bcd77db6957f881c3a6b54-123456789",
		},
		{
			"bar",
			"733e21b37cef883579a88183eed0d00cdeea0b59e1bcd77db6957f881c3a6b54",
			"raw/733e21b37cef883579a88183eed0d00cdeea0b59e1bcd77db6957f881c3a6b54",
			"raw/73/733e21b37cef883579a88183eed0d00cdeea0b59e1bcd77db6957f881c3a6b54-123456789",
		},
	}
...
func TestHttpProxyBackend(t *testing.T) {
	...
	testCache, err := New(cacheDir, cacheSize, "zstd", proxy)
	if err != nil {
		t.Fatal(err)
	}
...
func TestGetValidatedActionResult(t *testing.T) {
	...
	testCache, err := New(cacheDir, 1024*32, "zstd", nil)
	if err != nil {
		t.Fatal(err)
	}
...
func TestGetWithOffset(t *testing.T) {
	...
	testCache, err := New(cacheDir, blobSize*2, "zstd", nil)
	if err != nil {
		t.Fatal(err)
	}
