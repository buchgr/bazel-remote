...
func GetCliFlags() []cli.Flag {
	return []cli.Flag{
		...
		&cli.BoolFlag{
			...
			EnvVars:     []string{"BAZEL_REMOTE_OTEL_TRACING_ENABLED"},
		},
		&cli.StringFlag{
