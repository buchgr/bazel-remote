...
go_repository(
    ...
    sum = "h1:8XxGwQvx0pW96MJhDxaNvAgMgDxAu/XAnd6SHlokwz8=",
    version = "v0.0.0-20200504110755-7802003e0090",
)
...
go_repository(
    ...
    sum = "h1:lzLdP95xJmMpwQ6LUHwrc5V7js93hTiY7gkznu0BgmY=",
    version = "v0.0.0-20200501065659-ab2804fb9c9d",
)
