...
go_repository(
    ...
    sum = "h1:fLUZAWY+8rya7k1nmdB3+9KoqIVK/5t4dladjM3TMJ0=",
    version = "v0.0.0-20200224030109-f59419ca2cbf",
)
...
go_repository(
    ...
    sum = "h1:xFOdgVPpeowWAH0MJ5i0XMp+3yWiWamMtN/kx9xThIQ=",
    version = "v0.0.0-20200226201735-46b91f19d98c",
)
